...
func TestProcessorFullPage(t *testing.T) {
	...
	addComments(commentsIndex, commentsRepository, testUserID, false, 3)
	...
	testProcessor(t, commentsIndex, commentsRepository, "1", "2", expectedResponse)
}
...
func TestProcessorLastPage(t *testing.T) {
	...
	testProcessor(t, commentsIndex, commentsRepository, "2", "2", expectedResponse)
}
...
func TestProcessorBeyondLastPage(t *testing.T) {
	...
	addComments(commentsIndex, commentsRepository, testUserID, false, 3)
	expectedResponse := `[]`
	testProcessor(t, commentsIndex, commentsRepository, "3", "2", expectedResponse)
}

func TestProcessorNoPagination(t *testing.T) {
	commentsIndex := commentsMocks.NewIndex()
	commentsRepository := commentsMocks.NewRepository()
	addComments(commentsIndex, commentsRepository, testUserID, false, 50)
	...
	testProcessor(t, commentsIndex, commentsRepository, "", "", expectedResponse)
}

func TestProcessorTooLargePage(t *testing.T) {
	commentsIndex := commentsMocks.NewIndex()
	commentsRepository := commentsMocks.NewRepository()
	addComments(commentsIndex, commentsRepository, testUserID, false, 101)
	...
	testProcessor(t, commentsIndex, commentsRepository, "1", "101", expectedResponse)
}
...
func TestProcessorBadIndexEntry(t *testing.T) {
	...
	commentsRepository := commentsMocks.NewRepository()
	addComments(commentsIndex, commentsRepository, testUserID, false, 1)
...
func TestProcessorDeletedIndexEntry(t *testing.T) {
	commentsIndex := commentsMocks.NewIndex()
	commentsRepository := commentsMocks.NewRepository()
	addComments(commentsIndex, commentsRepository, testUserID, true, 1)
	expectedResponse := `[]`
	testProcessor(t, commentsIndex, commentsRepository, "1", "2", expectedResponse)
}

func addComments(commentsIndex *commentsMocks.Index, commentsRepository *commentsMocks.Repository, userID string, isDeleted bool, count int) {
...
func testProcessor(t *testing.T, commentsIndex *commentsMocks.Index, commentsRepository *commentsMocks.Repository, page string, pageSize string, expectedResponseBody string) {
