...
func TestProcessorFullPage(t *testing.T) {
	...
	addComments(commentsIndex, commentsRepository, usersRepository, testBattleID, false, 3)
	...
	testProcessor(t, commentsIndex, commentsRepository, usersRepository, testBattleID, "1", "2", expectedResponse)
}
...
func TestProcessorLastPage(t *testing.T) {
	...
	testProcessor(t, commentsIndex, commentsRepository, usersRepository, testBattleID, "2", "2", expectedResponse)
}
...
func TestProcessorBeyondLastPage(t *testing.T) {
	...
	addComments(commentsIndex, commentsRepository, usersRepository, testBattleID, false, 3)
	expectedResponse := `[]`
	testProcessor(t, commentsIndex, commentsRepository, usersRepository, testBattleID, "3", "2", expectedResponse)
}
...
func TestProcessorNoPagination(t *testing.T) {
	...
	commentsRepository := commentsMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addComments(commentsIndex, commentsRepository, usersRepository, testBattleID, false, 50)
	...
	testProcessor(t, commentsIndex, commentsRepository, usersRepository, testBattleID, "", "", expectedResponse)
}
...
func TestProcessorTooLargePage(t *testing.T) {
	...
	commentsRepository := commentsMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addComments(commentsIndex, commentsRepository, usersRepository, testBattleID, false, 101)
	...
	testProcessor(t, commentsIndex, commentsRepository, usersRepository, testBattleID, "1", "101", expectedResponse)
}
...
func TestProcessorBadIndexEntry(t *testing.T) {
	...
	commentsIndex.Upsert(comment)
	commentsRepository := commentsMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addComments(commentsIndex, commentsRepository, usersRepository, testBattleID, false, 1)
...
func TestProcessorDeletedIndexEntry(t *testing.T) {
	...
	commentsRepository := commentsMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addComments(commentsIndex, commentsRepository, usersRepository, testBattleID, true, 1)
	expectedResponse := `[{"id":"id0","battleId":"battleId0","createdOn":0,"username":"username0","comment":"[Deleted]"}]`
	testProcessor(t, commentsIndex, commentsRepository, usersRepository, testBattleID, "1", "2", expectedResponse)
}

func addComments(commentsIndex *commentsMocks.Index, commentsRepository *commentsMocks.Repository, usersRepository *usersMocks.Repository, battleID string, isDeleted bool, count int) {
...
func testProcessor(t *testing.T, commentsIndex *commentsMocks.Index, commentsRepository *commentsMocks.Repository, usersRepository *usersMocks.Repository, battleID string, page string, pageSize string, expectedResponseBody string) {
