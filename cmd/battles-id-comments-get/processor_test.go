...
func TestProcessorFullPage(t *testing.T) {
	...
	addComments(indexRepository, commentsRepository, testBattleID, false, 3)
	...
	testProcessor(t, indexRepository, commentsRepository, nil, testBattleID, "1", "2", expectedResponse)
}
...
func TestProcessorLastPage(t *testing.T) {
	...
	testProcessor(t, indexRepository, commentsRepository, nil, testBattleID, "2", "2", expectedResponse)
}
...
func TestProcessorBeyondLastPage(t *testing.T) {
	...
	addComments(indexRepository, commentsRepository, testBattleID, false, 3)
	expectedResponse := `[]`
	testProcessor(t, indexRepository, commentsRepository, nil, testBattleID, "3", "2", expectedResponse)
}

func TestProcessorNoPagination(t *testing.T) {
	indexRepository := indexMocks.NewRepository()
	commentsRepository := commentsMocks.NewRepository()
	addComments(indexRepository, commentsRepository, testBattleID, false, 50)
	...
	testProcessor(t, indexRepository, commentsRepository, nil, testBattleID, "", "", expectedResponse)
}

func TestProcessorTooLargePage(t *testing.T) {
	indexRepository := indexMocks.NewRepository()
	commentsRepository := commentsMocks.NewRepository()
	addComments(indexRepository, commentsRepository, testBattleID, false, 101)
	...
	testProcessor(t, indexRepository, commentsRepository, nil, testBattleID, "1", "101", expectedResponse)
}
...
func TestProcessorBadIndexEntry(t *testing.T) {
	...
	commentsRepository := commentsMocks.NewRepository()
	addComments(indexRepository, commentsRepository, testBattleID, false, 1)
...
func TestProcessorDeletedIndexEntry(t *testing.T) {
	indexRepository := indexMocks.NewRepository()
	commentsRepository := commentsMocks.NewRepository()
	addComments(indexRepository, commentsRepository, testBattleID, true, 1)
	expectedResponse := `[]`
	testProcessor(t, indexRepository, commentsRepository, nil, testBattleID, "1", "2", expectedResponse)
}

func addComments(indexRepository *indexMocks.Repository, commentsRepository *commentsMocks.Repository, battleID string, isDeleted bool, count int) {
...
func testProcessor(t *testing.T, indexRepository *indexMocks.Repository, commentsRepository *commentsMocks.Repository, authContext *api.AuthContext, battleID string, page string, pageSize string, expectedResponseBody string) {
