...
func TestProcessorFullPage(t *testing.T) {
	...
	addBattles(battlesIndex, battlesRepository, usersRepository, testSort, false, 3)
	...
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, nil, testSort, "1", "2", expectedResponse)
}
...
func TestProcessorLastPage(t *testing.T) {
	...
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, nil, testSort, "2", "2", expectedResponse)
}
...
func TestProcessorBeyondLastPage(t *testing.T) {
	...
	addBattles(battlesIndex, battlesRepository, usersRepository, testSort, false, 3)
	expectedResponse := `[]`
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, nil, testSort, "3", "2", expectedResponse)
}
...
func TestProcessorNoPagination(t *testing.T) {
	...
	battlesRepository := battlesMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addBattles(battlesIndex, battlesRepository, usersRepository, testSort, false, 50)
	...
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, nil, testSort, "", "", expectedResponse)
}
...
func TestProcessorTooLargePage(t *testing.T) {
	...
	battlesRepository := battlesMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addBattles(battlesIndex, battlesRepository, usersRepository, testSort, false, 101)
	...
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, nil, testSort, "1", "101", expectedResponse)
}
...
func TestProcessorNoSort(t *testing.T) {
	...
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, nil, "", "1", "1", expectedResponse)
}
...
func TestProcessorBadSort(t *testing.T) {
	...
	addBattles(battlesIndex, battlesRepository, usersRepository, testSort, false, 3)
	expectedResponse := `[{"id":"id0","createdOn":0,"username":"username0","title":"title0","description":"description0","canVote":false,"votesFor":0,"votesAgainst":0,"comments":0,"verdict":4}]`
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, nil, "bad", "1", "1", expectedResponse)
}
...
func TestProcessorBadIndexEntry(t *testing.T) {
	...
	battlesRepository := battlesMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addBattles(battlesIndex, battlesRepository, usersRepository, testSort, false, 1)
	expectedResponse := `[{"id":"id0","createdOn":0,"username":"username0","title":"title0","description":"description0","canVote":false,"votesFor":0,"votesAgainst":0,"comments":0,"verdict":4}]`
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, nil, testSort, "1", "2", expectedResponse)
}
...
func TestProcessorDeletedIndexEntry(t *testing.T) {
	...
	battlesRepository := battlesMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addBattles(battlesIndex, battlesRepository, usersRepository, testSort, true, 1)
	expectedResponse := `[]`
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, nil, testSort, "1", "2", expectedResponse)
}
...
func TestProcessorCanVoteFalse(t *testing.T) {
	...
	addBattles(battlesIndex, battlesRepository, usersRepository, testSort, false, 1)
	expectedResponse := `[{"id":"id0","createdOn":0,"username":"username0","title":"title0","description":"description0","canVote":false,"votesFor":0,"votesAgainst":0,"comments":0,"verdict":4}]`
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, authContext, testSort, "1", "2", expectedResponse)
}
...
func TestProcessorDeletedUser(t *testing.T) {
	battlesIndex := battlesMocks.NewIndex()
	battlesRepository := battlesMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	battle := &battles.Battle{
	...
	battlesIndex.Upsert(battle, 0, 0)
	expectedResponse := `[{"id":"id0","createdOn":3,"username":"[Deleted]","title":"title0","description":"description0","canVote":false,"votesFor":0,"votesAgainst":1,"comments":2,"verdict":3}]`
	testProcessor(t, battlesIndex, battlesRepository, usersRepository, nil, testSort, "1", "5", expectedResponse)
}
...
func TestProcessorVerdicts(t *testing.T) {
	...
	battlesIndex.Upsert(verdictNone, 0, 0)
	...
	battlesIndex.Upsert(verdictFor, 0, 0)
	...
	battlesIndex.Upsert(verdictAgainst, 0, 0)
	...
	battlesIndex.Upsert(verdictNoDecision1, 0, 0)
	...
	battlesIndex.Upsert(verdictNoDecision2, 0, 0)
...
func addBattles(battlesIndex *battlesMocks.Index, battlesRepository *battlesMocks.Repository, usersRepository *usersMocks.Repository, sort string, isDeleted bool, count int) {
	state := battles.Active
	if isDeleted {
...
func testProcessor(t *testing.T, battlesIndex *battlesMocks.Index, battlesRepository *battlesMocks.Repository, usersRepository *usersMocks.Repository, authContext *api.AuthContext, testSort string, page string, pageSize string, expectedResponseBody string) {
