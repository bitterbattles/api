...
func TestProcessorFullPage(t *testing.T) {
	...
	addBattles(indexRepository, battlesRepository, usersRepository, testSort, false, 3)
	...
	testProcessor(t, indexRepository, battlesRepository, usersRepository, nil, testSort, "1", "2", expectedResponse)
}
...
func TestProcessorLastPage(t *testing.T) {
	...
	testProcessor(t, indexRepository, battlesRepository, usersRepository, nil, testSort, "2", "2", expectedResponse)
}
...
func TestProcessorBeyondLastPage(t *testing.T) {
	...
	addBattles(indexRepository, battlesRepository, usersRepository, testSort, false, 3)
	expectedResponse := `[]`
	testProcessor(t, indexRepository, battlesRepository, usersRepository, nil, testSort, "3", "2", expectedResponse)
}
...
func TestProcessorNoPagination(t *testing.T) {
	...
	battlesRepository := battlesMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addBattles(indexRepository, battlesRepository, usersRepository, testSort, false, 50)
	...
	testProcessor(t, indexRepository, battlesRepository, usersRepository, nil, testSort, "", "", expectedResponse)
}
...
func TestProcessorTooLargePage(t *testing.T) {
	...
	battlesRepository := battlesMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addBattles(indexRepository, battlesRepository, usersRepository, testSort, false, 101)
	...
	testProcessor(t, indexRepository, battlesRepository, usersRepository, nil, testSort, "1", "101", expectedResponse)
}
...
func TestProcessorNoSort(t *testing.T) {
	...
	testProcessor(t, indexRepository, battlesRepository, usersRepository, nil, "", "1", "1", expectedResponse)
}
...
func TestProcessorBadSort(t *testing.T) {
	...
	addBattles(indexRepository, battlesRepository, usersRepository, testSort, false, 3)
	expectedResponse := `[{"id":"id0","createdOn":0,"username":"username0","title":"title0","description":"description0","canVote":false,"votesFor":0,"votesAgainst":0,"comments":0,"verdict":4}]`
	testProcessor(t, indexRepository, battlesRepository, usersRepository, nil, "bad", "1", "1", expectedResponse)
}
...
func TestProcessorBadIndexEntry(t *testing.T) {
	...
	battlesRepository := battlesMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addBattles(indexRepository, battlesRepository, usersRepository, testSort, false, 1)
	expectedResponse := `[{"id":"id0","createdOn":0,"username":"username0","title":"title0","description":"description0","canVote":false,"votesFor":0,"votesAgainst":0,"comments":0,"verdict":4}]`
	testProcessor(t, indexRepository, battlesRepository, usersRepository, nil, testSort, "1", "2", expectedResponse)
}
...
func TestProcessorDeletedIndexEntry(t *testing.T) {
	...
	battlesRepository := battlesMocks.NewRepository()
	usersRepository := usersMocks.NewRepository()
	addBattles(indexRepository, battlesRepository, usersRepository, testSort, true, 1)
	expectedResponse := `[]`
	testProcessor(t, indexRepository, battlesRepository, usersRepository, nil, testSort, "1", "2", expectedResponse)
}
...
func TestProcessorCanVoteFalse(t *testing.T) {
	...
	addBattles(indexRepository, battlesRepository, usersRepository, testSort, false, 1)
	expectedResponse := `[{"id":"id0","createdOn":0,"username":"username0","title":"title0","description":"description0","canVote":false,"votesFor":0,"votesAgainst":0,"comments":0,"verdict":4}]`
	testProcessor(t, indexRepository, battlesRepository, usersRepository, authContext, testSort, "1", "2", expectedResponse)
}
...
func TestProcessorDeletedUser(t *testing.T) {
	...
	indexRepository.SetScore(key, battle.ID, 0)
	...
	testProcessor(t, indexRepository, battlesRepository, usersRepository, nil, testSort, "1", "5", expectedResponse)
}
...
func addBattles(indexRepository *indexMocks.Repository, battlesRepository *battlesMocks.Repository, usersRepository *usersMocks.Repository, sort string, isDeleted bool, count int) {
...
func testProcessor(t *testing.T, indexRepository *indexMocks.Repository, battlesRepository *battlesMocks.Repository, usersRepository *usersMocks.Repository, authContext *api.AuthContext, testSort string, page string, pageSize string, expectedResponseBody string) {
