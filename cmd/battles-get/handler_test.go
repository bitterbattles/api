...
func TestHandlerNoPagination(t *testing.T) {
	...
	testHandler(t, ranksRepository, battlesRepository, sort, "", "", expectedResponse)
}
...
func testHandler(t *testing.T, ranksRepository *ranksMocks.Repository, battlesRepository *battlesMocks.Repository, sort string, page string, pageSize string, expectedResponseBody string) {
	...
	AssertEquals(t, response.StatusCode, http.OK)
	AssertEquals(t, response.Body, expectedResponseBody)
}
